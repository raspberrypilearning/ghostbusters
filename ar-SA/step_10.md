...
/ **
* قم بتعيين المعلومات حول أسئلتك هنا. يجب أن تطابق سلسلة الإجابة الصحيحة
* مع الاختيار الصحيح تمامًا ، كما هو الحال في مطابقة السلسلة. (حساس لحالة الأحرف)
*
* /
</code></pre>

<p>/ **
* دعنا نخلق العشوائية للأسئلة!
* /</p>

<p>دالة خلط الاوراق(array) {
  var currentIndex = array.length, temporaryValue, randomIndex;</p>

<p>/ / بينما لا تزال هناك عناصر للخلط...
  while (0 !== currentIndex) {</p>

<pre><code>// اختر عنصرًا متبقيًا...
...
<p><em>قد لا يعمل هذا الاختبار في المتصفح (Internet Explorer). إذا لم تتمكن من رؤية الاختبار ، فيرجى تجربة استخدام متصفح آخر.</em></p>
</script>